...
:::spoiler Discussion of incorrect applications of the GST formalization of partial synchrony to continuously operating protocols. ("You're doing it wrong!")
:::info
...
:::spoiler Adapting the Streamlet BFT protocol.
:::info
...
:::spoiler Why is this assumption needed?
:::info
...
:::spoiler Detail of "logically contains" for Zcash.
:::info
...
:::spoiler Is this model of contextual validity sufficient for Zcash?
:::info
...
:::spoiler Header validity for Proof‑of‑Work protocols.
:::info
...
:::spoiler Explain the confusion in the literature about what variants of this property are called.
:::info
...
:::spoiler Discussion of [GKL2020]'s communication model and network partition.
:::info
...
:::spoiler Why are this property, and Prefix Consistency above, stated as unconditional properties of protocol *executions*, rather than as probabilistic assumptions?
:::info
...
:::spoiler Why, intuitively, should we believe that Prefix Agreement and Prefix Consistency for a large enough confirmation depth hold with high probability for executions of a PoW‑based best‑chain protocol?
:::info
...
:::spoiler Why is the quantification over two *different* times *t* and *t′*?
:::info
...
:::spoiler Use of the headers_bc field, and its relation to the ch field in Snap‑and‑Chat.
:::info
...
:::spoiler Why is a distinguished value needed for the headers_bc field in the genesis bft‑block?
:::info
...
:::spoiler Why is the context_bft field needed? Why not use a final_bft field to refer directly to the last final bft‑block before the context block?
:::info
...
:::spoiler What about making the bc‑block producer the bft‑proposer?
:::info
...
:::spoiler Why have validity rules been separated from the honest voting condition below?
:::info
...
:::spoiler What does the **Increasing Score rule** do?
:::info
...
:::spoiler Why does the **Increasing Score rule** allow keeping the same snapshot as the parent?
:::info
...
:::spoiler Why is it not allowed to switch between snapshots with the same score?
:::info
...
:::spoiler How is it possible that the **Increasing Score rule** would not be satisfied by choosing headers from the proposer's bc‑best‑chain?
:::info
...
:::spoiler Wait what, how much validation is that?
:::info
...
:::spoiler Blocks in a bc‑best‑chain are by definition bc‑block‑valid. If we're checking the **Confirmed best‑chain criterion**, why do we need to have separately checked that the blocks referenced by the headers are bc‑block‑valid?
:::info
...
:::spoiler How does this compare to Snap‑and‑Chat?
:::info
...
::spoiler Explain the definition of finality‑depth.
:::info
...
:::spoiler Why not choose *T*  such that *H* ⌈<sup>1</sup><sub>bc</sub> . context_bft  ⪯<sub>bft</sub>  bft‑last‑final(*T* )?
:::info
...
:::spoiler Why choose the longest *C*, rather than the longest bft‑last‑final(*C* )?
:::info
...
:::spoiler Why this tie‑breaking rule?
:::info
